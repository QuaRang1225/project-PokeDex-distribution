...
class CustomData{
    ...
    var pokemonList = [
        PokemonsList(id: 1, color: "green", name: "이상해씨", base: Base(image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/1.png", types: ["독","풀"])),
        PokemonsList(id: 2, color: "green", name: "이상해풀", base: Base(image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/2.png", types: ["독","풀"])),
        PokemonsList(id: 3, color: "green", name: "이상해꽃", base: Base(image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/3.png", types: ["독","풀"]))
    ]
}
